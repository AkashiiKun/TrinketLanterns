...
public class LanternRenderer implements TrinketRenderer {
	public LanternRenderer(ItemStack itemStack, SlotReference slotReference, EntityModel<? extends LivingEntity> entityModel, PoseStack poseStack, MultiBufferSource multiBufferSource, int light, LivingEntity livingEntity, float limbSwing,
	...
	public void render(ItemStack itemStack, SlotReference slotReference, EntityModel<? extends LivingEntity> entityModel, PoseStack poseStack, MultiBufferSource multiBufferSource, int light, LivingEntity livingEntity, float limbSwing,
		...
		if(livingEntity.isCrouching()) {
			poseStack.translate(0.0F, 0.14F, 0.3F);
		}
		poseStack.translate(-.23, 0.69, 0.133);
